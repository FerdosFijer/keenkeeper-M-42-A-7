...
const FriendDetails = () => {
    ...
    const {name,picture,email,days_since_contact,status,bio,goal,next_due_date} =singleFriend;
     const {handleCallSmsVideo} =useContext();
        ...
        <div className="container mx-auto my-10 grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-4">
                ...
                <div className="card-body">
                    ...
                    <div className="card border" onClick={()=>handleCallSmsVideo(singleFriend)}>
