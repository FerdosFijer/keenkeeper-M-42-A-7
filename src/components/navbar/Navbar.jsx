...
const Navbar = () => {
 const links =(
    ...
    <li>
      <NavLink to={"/FriendshipAnalytics"}className={ ({isActive}) => `font-semibold mr-1 ${isActive ? "btn btn-ghost bg-teal-800 border border-teal-800 text-white" : "text-slate-500"}`}><TfiStatsUp /> Stats</NavLink>
    </li>
    </>
  )
    return (
